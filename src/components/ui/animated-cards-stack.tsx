...
const cardVariants = cva("absolute will-change-transform", {
  variants: {
    variant: {
      dark: "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-gray-600/50 bg-gray-800/95 p-6 backdrop-blur-md text-white",
      light:
        "flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-gray-600/50 bg-gray-800/95 p-6 backdrop-blur-md text-white",
    },
  },
  defaultVariants: {
    variant: "dark",
